...
class listing(models.Model):
    ...
    image_three = models.ImageField(upload_to='images/', height_field=None, width_field=None, max_length=100)
    public_token = models.CharField(max_length=200, default=secrets.token_urlsafe(22))
    secret_token = models.CharField(max_length=200, default=secrets.token_urlsafe(22))
