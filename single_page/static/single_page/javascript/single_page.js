$(document).ready(function(){
  ...
  $("#search-input-large").on("change enter", function(){
    ...
    new_url.searchParams.set('search',document.getElementById("search-input-large").value.split(' ').join('_'));
  ...
  $("#search-input-small").on("change enter", function(){
    console.log('Test');
    new_url = new URL(window.location.origin);
    new_url.searchParams.set('search',document.getElementById("search-input-small").value.split(' ').join('_'));
    window.location.replace(new_url.href);
